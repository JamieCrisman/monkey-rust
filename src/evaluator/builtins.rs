...
pub fn new_builtins() -> HashMap<String, Object> {
    ...
    builtins.insert(String::from("len"), Object::Builtin(1, b_len));
    builtins.insert(String::from("first"), Object::Builtin(1, b_first));
    builtins.insert(String::from("last"), Object::Builtin(1, b_last));
    builtins.insert(String::from("rest"), Object::Builtin(1, b_rest));
    builtins.insert(String::from("push"), Object::Builtin(2, b_push));
    builtins
}
